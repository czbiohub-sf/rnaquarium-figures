...
def main() -> None:
    ...
    # Stable label order (keep 'no_infection' first if present)
    ...
    # Save score matrix (decision function per class)
    ...
    # Save gene importance per class from LinearSVC coefficients
    coef = svc.coef_
