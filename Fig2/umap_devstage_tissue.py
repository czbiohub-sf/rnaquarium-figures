#!/usr/bin/env python3
"""
Figure 2 Panels A and C: Transcriptome clustering UMAPs
...
out_devstage = OUTPUT_DIR / "Fig2_A_umap_devstage_curation.svg"
...
_apply_umap_style(fig)
out_tissue = OUTPUT_DIR / "Fig2_C_umap_tissue_curation_coarse.svg"
...
if LEGEND_STYLE == "dot":
    _draw_legend_dot(
        devstage_color_map,
        DEVSTAGE_ORDER,
        OUTPUT_DIR / "Fig2_A_umap_devstage_curation_legend.svg",
        counts_map=devstage_counts_map,
    )
    _draw_legend_dot(
        tissue_color_map,
        tissue_ordered,
        OUTPUT_DIR / "Fig2_C_umap_tissue_curation_coarse_legend.svg",
